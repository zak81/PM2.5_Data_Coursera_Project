...
## Use dplyr function filter to filter a five-digit number for Baltimore City
...
plot(ttl_emissions, xaxt = "n", yaxt = "n", xlab = "", ylab = "", type = "b", 
     col = "blue", main = expression(paste("Total PM " [2.5], " emissions in Baltimore City, Maryland")))
